...
using Tyuiu.PanovRR.Sprint0.Task7.V0.Lib;

namespace Tyuiu.PanovRR.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнил Панов Р.Р | АСОиУБ-26-1";
            ...
            Console.WriteLine("* Выполнил: Панов Роман Романович | АСОиУБ-26-1                           *");
            Console.WriteLine("***************************************************************************");
